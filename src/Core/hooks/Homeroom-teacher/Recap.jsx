...
import { fetchSummaryClass as getHeaderAPI, fetchSummaryClassdaily as getTableApi, fetchSummaryClassCard as getCardApi, getCetakRecap } from "@/core/services/role-homeroom/summary-class/summary-class";
...
export function UseRecap(selectedDate) {
  ...
  const loadTableData = useCallback(async (page = 1, search = searchQuery, status = selectedStatus, showLoading = true) => {
  ...
  useEffect(() => {
    const handler = setTimeout(() => {
      ...
      loadTableData(1, searchQuery, selectedStatus, !isSearching);
    }, 500);
