...
import { getMajors, getSchoolYears,getLevelClass,getTeachers } from "../../api/class-major/classApi";
...
export default function useMasterData() {
    ...
    const fetchMasterData = async () => {
        ...
        try {
            ...
            const [majorsRes, schoolYearsRes,levelClassRes, teachersRes,] = await Promise.all([
                getMajors(),
                getSchoolYears(),
                getLevelClass(),
                getTeachers(),
