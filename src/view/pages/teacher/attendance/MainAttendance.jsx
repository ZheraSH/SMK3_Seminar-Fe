...
export default function AttendanceTeacher() {
  ...
  return (
    <div className="justify-center mb-10">
      ...
      {loading ? (
        <LoadingData loading={loading} type="tombolDay2" count={5} />
      ) : (
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 w-full animate-in fade-in duration-500">
            <img
              ...
              alt="Data Kosong"
              className="w-48 h-auto md:w-[400px] md:h-[285px] mb-6"
            />
            <p className="text-gray-500 text-center text-sm md:text-md">
              Maaf yaaa.. datanya gaada, silahkan konsultasi kelas <br />
              mengajar anda ke operator!
            </p>
          </div>
        )}
      </div>
