...
export default function TotalClass({
  ...
  return (
    <>
        <div className="flex gap-2 pb-2 flex-wrap h-[70px] w-[1129px] justify-between bg-white shadow-md p-2 rounded-lg mt-4">
        ...
        <div className="flex gap-[12px] items-center">
            ...
            className={`flex items-center gap-1 w-[120px] justify-center h-[37px] rounded-xl text-white font-poppins ${
                isButtonDisabled
