...
import useAttendanceStatistics from "@core/hooks/counselor/statistik-global/use-statistik-global";
      ...
      <ul className="space-y-1 max-h-60 overflow-y-auto">
        {options.map((option) => (
          <li
            ...
            className={`px-3 py-2 text-sm text-gray-700 rounded-lg cursor-pointer transition ${option.value === activeValue
    ...
    return (
      <div className="p-4 bg-gray-50 min-h-screen">
        <div className="p-6 text-center bg-red-100 border border-red-400 text-red-700 rounded-xl">
          ...
          <p>
            {errorStatistics}. Coba muat ulang halaman atau klik tombol di
            bawah.
          </p>
          <button
            onClick={refreshStatistics}
            className="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition duration-150"
          >
            Muat Ulang Data
          </button>
        </div>
