...
function StudentCard({ student }) {
  const [src, setSrc] = useState(student.image);

  const handleError = () => {
    setSrc("/images/team/ega.jpg");
  };

  return (
    <div className="relative bg-[url('/images/cardbg/CardBg.png')] bg-center w-[150px] h-[110px] md:w-[220px] md:h-[150px] mb-4 shadow-md hover:shadow-lg transition-shadow rounded-2xl flex flex-col items-center">
      <img
        src={src}
        alt="student"
        onError={handleError}
