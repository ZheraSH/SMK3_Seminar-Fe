        ...
        return (
            <div className="w-full min-h-[250px] flex flex-col items-center justify-center p-6 transition-all">
                ...
                <div className="mb-4 transform transition-transform hover:scale-105">
                    <img src="/images/null/null4.png" alt="Data Kosong" className="w-26 h-26 md:w-36 md:h-36 object-contain opacity-80"/>
                </div>
        ...
        <table className="w-full table-fixed border-collapse  rounded-lg ">
            <thead className="block">
                <tr className="table w-full table-fixed bg-[#3B82F6] h-[40px] text-white text-[12px] font-semibold rounded-t-md">
                    <th className="w-[16%] text-center pl-2 py-2 font-semibold  rounded-tl-md">No</th>
                    <th className="w-[40%] text-center pl-2 font-semibold ">Mata Pelajaran</th>
                    <th className="w-[40%] text-center font-semibold ">Guru</th>
                    <th className="w-[30%] text-center  font-semibold" >Jam</th>
            ...
            <tbody className={`block max-h-[232px] overflow-y-auto 
                ...
                {displayedSchedule.map((s, index) => {
                    ...
                    return (
                        <tr key={index} className={`${rowClassName} table w-full table-fixed text-[8px] md:text-[10px] lg:text-[14px] border border-[#000000]/20`}>
                            <td className="w-[16%] h-[46px] text-center align-middle">
                                {index + 1}.
                            </td>
                            ...
                            <td className="w-[40%] h-[46px] px-2 align-middle text-center overflow-hidden text-ellipsis whitespace-nowrap">
                                {s.teacher}
                            </td>
