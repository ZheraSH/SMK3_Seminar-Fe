  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-[700px] max-h-[90vh] overflow-y-auto p-6 relative">
        ...
        <h2 className="text-2xl font-semibold mb-6 text-gray-800">{editingId ? "Edit Siswa" : "Tambah Siswa"}</h2>
        ...
        <form onSubmit={onSubmit} className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={onInputChange}
            />
            {errors.nisn && <p className="text-red-500 text-sm mt-1">{errors.nisn[0]}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={onInputChange}
            />
            {errors.number_kk && <p className="text-red-500 text-sm mt-1">{errors.number_kk[0]}</p>}
          </div>

          {/* Field Saudara Ke */}
          <div>
            <label className="block text-sm font-medium text-gray-600">Saudara Ke *</label>
            <input
              className={`border rounded-lg p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              ...
              onChange={onInputChange}
            />
            {errors.count_siblings && <p className="text-red-500 text-sm mt-1">{errors.count_siblings[0]}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={onInputChange}
            />
            {errors.number_akta && <p className="text-red-500 text-sm mt-1">{errors.number_akta[0]}</p>}
          </div>

          {/* Field Anak Ke */}
          <div>
            <label className="block text-sm font-medium text-gray-600">Anak Ke *</label>
            <input
              className={`border rounded-lg p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              ...
              onChange={onInputChange}
            />
            {errors.order_child && <p className="text-red-500 text-sm mt-1">{errors.order_child[0]}</p>}
          </div>

          {/* Field Jurusan */}
          <div>
            <label className="block text-sm font-medium text-gray-600">Jurusan *</label>
            <select
              name="majors"
              className={`border rounded-lg p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 ${
            ...
            {errors.majors && <p className="text-red-500 text-sm mt-1">{errors.majors[0]}</p>}
          </div>

          {/* Field Tingkatan */}
          <div>
            <label className="block text-sm font-medium text-gray-600">Tingkatan *</label>
            <select
              name="levelclasses"
              className={`border rounded-lg p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 ${
            ...
            {errors.levelclasses && <p className="text-red-500 text-sm mt-1">{errors.levelclasses[0]}</p>}
          </div>
