  ...
  return (
    ...
    >
      ...
      >
        ...
        <ChevronRight
          className={`w-4 h-4 text-gray-500 transition-transform ${openCategory ? "rotate-90" : "rotate-0"
            }`}
        />
      </button>
        ...
        <div className="absolute top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 p-2 z-20">
          ...
          <div className="border-b border-gray-100">
            ...
            >
              Jenis Kelamin
              <ChevronRight
                className={`w-4 h-4 text-gray-400 transition-transform ${openSubMenu === "gender" ? "rotate-90" : ""
                  }`}
              />
            </button>
            {openSubMenu === "gender" && (
...
<<<<<<< HEAD:src/view/pages/operator/teachers/components/FilterDropdown.jsx
                      ? "bg-blue-100 text-blue-700 font-semibold"
                      : "hover:bg-gray-100 text-gray-700"
=======
                        ? "bg-blue-100 text-blue-700 font-semibold"
                        : "hover:bg-gray-100 text-gray-700"
>>>>>>> dev2:src/view/pages/operator/teachers/components/filter-dropdown.jsx
                      }`}
                  >
                    {g.label}
                  </button>
          ...
          <div className="border-b border-gray-100">
            ...
            >
              Role
              <ChevronRight
                className={`w-4 h-4 text-gray-400 transition-transform ${openSubMenu === "role" ? "rotate-90" : ""
                  }`}
              />
            </button>
            {openSubMenu === "role" && (
