...
    return (
        <div className="fixed inset-0 bg-gray-600/50 flex items-center justify-center z-50 p-4"> {/* Tambahkan p-4 */}
            <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-6 text-center"> {/* Gunakan max-w-sm dan w-full */}
                <div className={`mx-auto flex items-center justify-center h-12 w-12 rounded-full mb-4 ${bgColor}`}>
                    {icon}
                </div>
                <h3 className="text-lg font-bold text-gray-800 mb-2">{title}</h3>
                <p className="text-sm text-gray-700 mb-6">{message}</p>
                <button onClick={onClose} className="w-full px-4 py-2 text-sm rounded-lg text-white font-semibold bg-blue-600 hover:bg-blue-700 transition-colors">
                    Tutup
                </button>
            </div>
        </div>
...
    return (
        <div className="fixed inset-0 bg-gray-600/50 flex items-center justify-center z-50 p-4"> {/* Tambahkan p-4 */}
            <div className="bg-white rounded-lg shadow-xl w-full max-w-sm p-6"> {/* Gunakan max-w-sm dan w-full */}
...
                    <button onClick={onCancel} disabled={isProcessing} className="px-4 py-2 text-sm rounded-lg text-gray-700 border border-gray-300 hover:bg-gray-100 transition-colors disabled:opacity-50">
                        Batal
                    </button>
...
                </div>
                
                <div className="flex space-x-1 bg-gray-100 rounded-lg shadow-inner w-full  md:w-90 overflow-x-auto md:overflow-hidden p-1 mb-6">
                    {daysIndo.map(day => (
                        <button 
                            key={day} 
                            onClick={() => setActiveDayIndo(day)}
                            className={`flex-shrink-0 px-3 py-2 text-sm font-semibold rounded-lg transition-colors duration-200 ${ /* flex-shrink-0 agar tombol tidak menciut */
                                activeDayIndo === day 
