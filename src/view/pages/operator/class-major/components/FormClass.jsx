            ...
            <div className="w-full relative">
                ...
                <div onClick={() => setOpen(!open)} className={`w-full px-4 py-3 bg-gray-200 border ${error ? "border-red-500" : "border-gray-300"} rounded-xl flex justify-between items-center cursor-pointer`}>
                    <span className={value ? "text-black" : "text-gray-500"}>
                        {value ? (data.find(i => i.id === value)?.code || data.find(i => i.id === value)?.name) : placeholder}
                    </span>
        ...
        <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Dropdown
                    ...
                    data={levelClass}
                    value={levelClassId}
                    onChange={(val) => { setLevelClassId(val); setErrors({ ...errors, levelClassId: "" }); }}
                ...
                <Dropdown
                    ...
                    data={majors}
                    value={majorId}
                    onChange={(val) => { setMajorId(val); setErrors({ ...errors, majorId: "" }); }}
                ...
                <div className="w-full">
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-3 bg-gray-200 border ${errors.classNameInput ? "border-red-500" : "border-gray-300"} rounded-xl`}
               ...
               <div className="grid grid-cols-2 gap-4 col-span-3 w-full">
                    ...
                    data={schoolYears}
                    value={schoolYearId}
                    onChange={(val) => { setSchoolYearId(val); setErrors({ ...errors, schoolYearId: "" }); }}
                ...
                <Dropdown
                    ...
                    data={teachers}
                    value={teacherId}
                    onChange={(val) => { setTeacherId(val); setErrors({ ...errors, teacherId: "" }); }}
