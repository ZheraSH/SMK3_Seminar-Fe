...
const ClassCard = ({ classData }) => {
  ...
  return (
    <div className="bg-white h-[172px] border border-gray-200 rounded-xl shadow-md p-4 flex flex-col justify-between transition duration-300 hover:shadow-lg" >
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center  text-white bg-[#3B82F6] h-[31px] px-3 rounded-lg">
          <div className="p-2">
            <GraduationCap className="w-5 h-5 " />
          </div>
          <h3 className="lg:text-[16px] md:text-[14px]  font-semibold">{classData.name}</h3>
        </div>
      ...
      <div className="space-y-2 mb-1 flex justify-between items-center">
        <div className="text-gray-600">
          ...
          <p className="font-medium text-[12px] text-[#444444]">{ classData.homeroom_teacher }</p>
        </div>
