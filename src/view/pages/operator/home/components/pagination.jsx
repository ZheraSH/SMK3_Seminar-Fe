    ...
    return (
        <div className="flex items-center justify-center py-4 gap-2 select-none">
            ...
            <button
                ...
                className={`w-8 h-8 flex items-center justify-center  ${page === 1 ? "opacity-50 cursor-not-allowed" : "text-gray-600"}`}
            >
                &lt;
            </button>
            ...
            <button
                ...
                onClick={() => onPageChange(page + 1)}
                className={`w-8 h-8 flex items-center justify-center ${page === lastPage ? "opacity-50 cursor-not-allowed" : "text-gray-600"}`}
            >
                &gt;
            </button>
        </div>
