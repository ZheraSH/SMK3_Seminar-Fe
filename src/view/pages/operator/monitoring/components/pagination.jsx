...
const Pagination = ({ meta, onPageChange }) => {
    ...
    const PageButton = ({ p, active }) => (
        <button 
            ...
            className={`w-[28px] h-[28px] rounded-sm flex items-center justify-center transition-all text-sm font-medium
              ${active
    ...
    return (
        <div className="flex items-center justify-center mt-8 gap-1 select-none font-sans space-x-2">
            ...
            {endPage < lastPage && (
                <>
                    {endPage < lastPage - 1 && <span className="text-[#3B82F6] px-1 font-bold">...</span>}
