  ...
  return (
    <div className="w-full mt-6">
      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 mb-5">
        ...
        <div className="border border-gray-700 rounded-[15px] px-3 py-2 text-sm flex items-center gap-2">
          <select className="appearance-none bg-transparent outline-none text-sm">
        ...
        <button className="border border-gray-700 rounded-[15px] px-3 py-2 text-sm">
          <input type="date" className="bg-transparent outline-none" />
        </button>

        <div className="flex sm:ml-auto gap-3">
          <button className="bg-[#10B981] text-white px-4 py-2 rounded-[12px] text-sm flex items-center gap-1.5">
