  ...
  return (
    <>
      <div className="flex h-screen bg-gray-50 overflow-hidden">
        ...
        <Notification />
        <aside className={`fixed top-0 left-0 h-full bg-white text-[#4B5563] shadow-lg transition-all duration-300 z-40 ${sidebarOpen ? "w-[250px] translate-x-0" : "w-[250px] -translate-x-full lg:translate-x-0 lg:w-[80px]"}`} >
