        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-md pr-0 lg:mr-0.5">
          ...
          <div className="px-4 md:px-7 pt-12 pb-16">
            ...
            <div className="mt-5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-6 ml-4 md:ml-6">
                <div className="space-y-5">
                  <InfoRow label="Nama Lengkap" value={user.name} />
                  <InfoRow label="Kelas" value={user.kelas || "XII PPLG 3"} />
                  <InfoRow
                    label="Jenis Kelamin"
                ...
                <div className="space-y-5">
                  ...
                  />
                  <InfoRow label="Tahun Ajaran" value="2024/2025" />
                </div>
              </div>
            </div>
          </div>
...
function InfoRow({ label, value }) {
  return (
    <div className="flex items-start ">
      <span className=" md:w-50 lg:w-40 font-medium text-[15px] md:text-[25px] lg:text-lg text-black shrink-0">
        {label}
      </span>
