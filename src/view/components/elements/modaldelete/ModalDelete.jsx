        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-[16px] shadow-xl max-w-md h-[274] w-[408px] p-5 overflow-hidden transform transition-all flex flex-col items-center text-center">
                ...
                <div className="flex space-x-4 w-full justify-center">
                    ...
                    <button onClick={onConfirm} disabled={loading} className={`w-[80px] h-[37px] bg-[#EF4444] text-white rounded-[10px] text-[14px] font-medium hover:bg-red-600 transition cursor-pointer flex items-center justify-center ${loading ? "opacity-70 cursor-not-allowed" : ""}`}>
                        {loading ? (
